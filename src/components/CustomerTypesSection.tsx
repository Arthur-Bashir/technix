...
export const CustomerTypesSection: React.FC<CustomerTypesSectionProps> = ({ onOpenQuote }) => {
  const industries = [
    ...
    },
    {
      ...
      keyDeliverables: [
        'Executive profile websites designed to pass formal tender reviews',
        'Encrypted business email with mobile and PC synchronization',
    ...
    },
    {
      ...
      howTechNixHelps: 'We partner with enterprise IT directors to extend their engineering capacity: building bespoke internal portals, conducting cybersecurity audits, and providing multi-site infrastructure support.',
      keyDeliverables: [
        'Custom enterprise modules and multi-branch database sync',
        'Cybersecurity health checks, penetration audits & hardening',
        'Dedicated priority SLA infrastructure retainers',
