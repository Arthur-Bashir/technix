...
export const QuickNeedSelector: React.FC<QuickNeedSelectorProps> = ({
  ...
  const pathways = [
    ...
    },
    {
      ...
      summary: 'Replace fragmented spreadsheets and paper logs with custom management portals, multi-branch stock tracking, and structured record systems.',
    ...
    },
    {
      ...
      summary: 'Rapid physical and remote technician assistance in Blantyre & Lilongwe when computers crash, networks fail, or files are lost.',
    ...
    },
    {
      ...
      summary: 'Upgrade from personal @gmail.com accounts to verified company email (name@yourcompany.mw) that presents an official commercial identity.',
    ...
    },
    {
      ...
      summary: 'Stable cloud servers with regular backups, SSL certificates, and convenient local Kwacha billing without international card requirements.',
    ...
    },
    {
      ...
      summary: 'Interactive dashboards and offline mobile data collection pipelines for management oversight, grant reporting, and partner accountability.',
    ...
    },
    {
      ...
      summary: 'Practical, hands-on masterclasses in Advanced Microsoft Excel, Power BI dashboards, and modern workplace digital tools taught by experienced instructors.',
      deliverables: ['100% practical computer lab exercises', 'Small interactive cohorts', 'Practical course templates and materials', 'Custom on-site corporate workshops'],
