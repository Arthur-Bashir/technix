...
import { ShieldCheck, CheckCircle2, HeartHandshake, Stethoscope, Building2 } from 'lucide-react';
  ...
  const clientRelationships = [
    {
      ...
      statement: 'TechNix has provided IT support services to PACT Malawi since 2017.',
      icon: HeartHandshake,
    ...
    },
    {
      ...
      statement: 'TechNix has worked with Save the Children on database system development projects.',
      icon: Building2,
    ...
    },
    {
      ...
      statement: 'TechNix has developed website and intranet solutions for Malawi Red Cross Society.',
      icon: Stethoscope,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
          <div className="inline-flex items-center space-x-2 bg-white border border-slate-200 shadow-2xs rounded-full px-4 py-1 text-xs font-bold text-slate-700">
            ...
            <span>Trusted Technology Experience</span>
          </div>

          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight">
            Technology experience built across real organisations.
          </h2>

          <p className="text-base sm:text-lg text-slate-600">
            TechNix has supported organisations across development, humanitarian, education and business environments with software, websites and IT services.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-500 mb-3">{item.category}</p>
                </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xs">
          <div className="flex items-center space-x-3 text-center md:text-left">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-900">Local Technology Partner</h4>
              <p className="text-xs text-slate-600">Malawi-based technical support for organisations that need practical technology solutions.</p>
            </div>
          </div>
          <div className="flex items-center space-x-2 text-xs font-semibold text-slate-700 bg-slate-50 px-4 py-2 rounded-xl border border-slate-200">
            <span>Talk to TechNix About Your Project</span>
          </div>
        </div>
      </div>
    </section>
